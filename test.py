...
CHECKPOINT_PATH = Path(r"E:\YOLO\D-FINE\output\新版数据集m-512_200轮\best_map50.pth")
...
TEST_OUTPUT_DIR = Path(r"E:\YOLO\D-FINE\output\新版数据集m-512_200轮\修正测试集精度指标")

# 只影响论文 TXT 中的显示名称，不参与权重加载。
PAPER_MODEL_NAME = "修正测试dfine-m-512_200"
