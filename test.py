...
CHECKPOINT_PATH = Path(r"G:\b1\权重结果\改进实验dfine\qlcs_qfbcg\2e-4_SD3407\best_map50.pth")
...
TEST_OUTPUT_DIR = Path(r"G:\b1\权重结果\改进实验dfine\qlcs_qfbcg\2e-4_SD3407\测试集精度")

# 只影响论文 TXT 中的显示名称，不参与权重加载。
PAPER_MODEL_NAME = "qlcs_qfbcg_2e-4_SD3407"
