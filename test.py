...
CHECKPOINT_PATH = Path(r"G:\b1\权重结果\改进实验dfine\rba\2e-4_SD73\best_map50.pth")
...
TEST_OUTPUT_DIR = Path(r"G:\b1\权重结果\改进实验dfine\rba\2e-4_SD73\测试集精度")

# 只影响论文 TXT 中的显示名称，不参与权重加载。
PAPER_MODEL_NAME = "rba_SD73"
