...
# 用户验证参数配置区：直接填写绝对路径
# =============================================================================
# 由 experiment_config.py 的 MODEL_SIZE 选择与训练一致的 S/M/L/X 模型配置。
...
CHECKPOINT_PATH = r"E:\YOLO\权重结果\D-FINE\m-512_150epoch\best_map50.pth"
...
VALID_OUTPUT_DIR = r"E:\YOLO\权重结果\D-FINE\m-512_150epoch\验证集精度"

# 只控制“论文指标.txt”中的显示名称，不参与模型结构或权重加载。
PAPER_MODEL_NAME = "dfine-m512_150"
