...
CHECKPOINT_PATH = r"G:\b1\权重结果\改进实验dfine\qlcs_dsqc\SD18_2e-4\best_map50.pth"
...
VALID_OUTPUT_DIR = r"G:\b1\权重结果\改进实验dfine\qlcs_dsqc\SD18_2e-4\再次验证集精度"

# 只控制“论文指标.txt”中的显示名称，不参与模型结构或权重加载。
PAPER_MODEL_NAME = "againqlcs_dsqc_2e-4_SD18"
